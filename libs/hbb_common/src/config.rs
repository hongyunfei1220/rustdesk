...
pub const RENDEZVOUS_SERVERS: &[&str] = &["yd.bthyf.top"];
pub const PUBLIC_RS_PUB_KEY: &str = "cWpiMx5vUAhnu2Of0q0SxCONTHJeQh5tOGDGA82Etdo=";
...
pub const RENDEZVOUS_PORT: i32 = 22118;
pub const RELAY_PORT: i32 = 22119;
